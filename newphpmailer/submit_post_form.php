...
//Create html page for the users data 
    ...
    $message .= '</body></html>';
//End Html Page Here
//Old SMTP code - before 2017-04-19
//$mail = new PHPMailer;
...
////$mail->SMTPDebug = 1;
////$mail->SMTPDebug = 2;
//New SMTP code - since 2017-04-19
    $mail = new PHPMailer;
    $mail->SMTPDebug = 0;
    $mail->isSMTP();
    $mail->Host = 'localhost';
...
//$mail->addBCC('abhishek.kamble@supramind.com');
//$mail->addBCC('shaileshghadge@gmail.com');
//$mail->addBCC('shailesh.ghadge@yahoo.co.in');
//$mail->addBCC('rohit@supramind.com');
